...
class crudmedicamento{
	...
	public function agregar($datos){
		...
		$sql="INSERT INTO medicamento (codigoatc_mto,nombre_mto,estado_mto)
	...
	public function obtenDatos($idmed){
		...
		$sql="SELECT id_medicamento,codigoatc_mto,nombre_mto FROM medicamento WHERE id_medicamento='$idmed'";
	...
	public function actualizar($datos){
		...
		$sql="UPDATE medicamento SET codigoatc_mto='$datos[1]', nombre_mto='$datos[2]' WHERE id_medicamento='$datos[0]'";
		return mysqli_query($conexion,$sql);
	}
