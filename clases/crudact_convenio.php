...
class crudact_convenio{
	...
	public function agregar($datos){
		...
		$sql="INSERT INTO convenio_detalle (id_convenio, descripcion_cdet, tipo_cdet, codigo_cdet, valor_cdet, estado_cdet)
		VALUES ('$_SESSION[gid_convenio]','$datos[0]','$datos[1]','$datos[2]','$datos[3]','A')";
		//echo $sql;
