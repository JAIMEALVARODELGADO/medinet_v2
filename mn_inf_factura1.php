                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="chk_fecha_fac" id="chk_fecha_fac" checked="true">Fecha de la factura
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="chk_fechacierre_fac" id="chk_fechacierre_fac">Fecha de cierre
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
