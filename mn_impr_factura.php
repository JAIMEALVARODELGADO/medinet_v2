...
$confac="SELECT id_factura, numero_fac, tipoiden_per, numero_iden_per, nombre_pac, direccion_per, telefono_per, numero_conv, nombre_eps, SUBSTR(fecha_fac,1,10), valortot_fac, copago_fac, descuento_fac, valorneto_fac, esta_fac, identif_operador, nombre_operador 
...
<body>
    <div class="container-fluid">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">Fecha:  <?php echo $fecha_fac;?></div>
                <div class="col-sm-6" align="right"><b>Número:  <?php echo $numero_fac;?></b></div>
            </div>
