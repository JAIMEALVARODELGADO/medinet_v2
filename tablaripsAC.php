...
$sql="SELECT id_ripsac, numero_fac, fechacon_rac, numeroauto_rac, codigocon_rac, finalidad_rac, causaexte_rac, dxprincipal_rac, dxrel1_rac, dxrel2_rac, dxrel3_rac, tipodxprin_rac,valorcon_rac,valorcmode_rac FROM vw_ripsac WHERE id_ccobro='$_SESSION[gid_ccobro]'";
//echo "<br>".$sql;
