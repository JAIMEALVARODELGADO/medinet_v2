...
$sql="SELECT vw_agenda_medico.id_agc,fecha_agh,numero_iden_per,nombre,estado_agc,nombre_profesional,id_con,observacion_agc
FROM vw_agenda_medico
LEFT JOIN consulta ON consulta.id_agc=vw_agenda_medico.id_agc
			...
			while($row=mysqli_fetch_row($result)){
				...
				<tr>
					<td style="text-align: center;">
						<?php
							if($row[4]=='Inasistencia' or $row[4]=='Cumplida'){
								?>
