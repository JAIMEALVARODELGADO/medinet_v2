            ...
            <div class="col-sm-12">
                <div class="card text-left">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-6 col-form-label">EPS: <?php echo $nombre_eps;?></label>
                        <label class="col-sm-6 col-form-label">Número: <?php echo $numero_conv;?></label>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-6 col-form-label">Fecha: <?php echo $fecha_conv;?></label>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frm_nuevo">
                        ...
                        <label>Valor</label>
                        <input type="number" class="form-control input-sm" id="valor_cdet" name="valor_cdet">
                    </form>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frm_editar">
                        ...
                        <label>Valor</label>
                        <input type="number" class="form-control input-sm" id="valor_cdetU" name="valor_cdetU">
