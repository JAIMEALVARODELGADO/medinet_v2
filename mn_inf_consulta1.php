                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="chk_fecha_con" id="chk_fecha_con" checked="true">Fecha de la consulta
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="col-sm-12">                            
                            <label for="orden">
                                ...
                                <select class="form-control form-control-sm" name="orden" id="orden">
                                    <option value="fecha_con">FECHA CONSULTA</option>
...
<script type="text/javascript">
    ...
    function actcampos(){        
        ...
        if($('#chk_fecha_con').prop('checked')==true){
            campos+="fecha_con AS FECHA_CONSULTA,";
        }
